		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "fzf",
					Version:       "v0.55.0",
					Asset:         map[string]string{"darwin/arm64": "fzf-{version}-darwin_arm64.tar.gz", "linux/amd64": "fzf-{version}-linux_amd64.tar.gz"},
					Bins:          []string{"fzf"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "packer",
					Version:       "v1.11.0",
					Asset:         map[string]string{"darwin/arm64": "packer_{version}_darwin_arm64.zip", "linux/amd64": "packer_{version}_linux_amd64.zip"},
					Bins:          []string{"packer"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "go",
					Version:       "go1.26.0",
					Asset:         map[string]string{"darwin/arm64": "go{version}.darwin-arm64.tar.gz", "linux/amd64": "go{version}.linux-amd64.tar.gz"},
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "secretlint",
					Version:       "v10.2.0",
					Asset:         map[string]string{"darwin/arm64": "secretlint-{version}-darwin-arm64", "linux/amd64": "secretlint-{version}-linux-amd64"},
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "xo",
					Version:       "v0.1.1",
					Asset:         map[string]string{"darwin/arm64": "xo-{version}-darwin-arm64.tar.bz2", "linux/amd64": "xo-{version}-linux-amd64.tar.bz2"},
					Bins:          []string{"xo"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "ls-lint",
					Version:       "v2.3.1",
					Asset:         map[string]string{"darwin/arm64": "ls-lint-darwin-arm64.tar.gz", "linux/amd64": "ls-lint-linux-amd64.tar.gz"},
					Bins:          []string{"ls-lint"},
					VersionPrefix: "",
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:            "golangci-lint",
					Version:         "v2.11.4",
					Asset:           map[string]string{"darwin/arm64": "golangci-lint-{version}-darwin-arm64.tar.gz", "linux/amd64": "golangci-lint-{version}-linux-amd64.tar.gz"},
