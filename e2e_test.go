...
func generateFromConfigAndLock(t *testing.T, configPath, lockPath, outDir string, p platform.Platform) {
	...
	inputs := make([]generator.GenerateInput, 0, len(cfg.Tools))
...
func TestE2E_LockFileRoundTrip(t *testing.T) { //nolint:funlen,gocognit,cyclop // e2e round-trip verification
	t.Parallel()
